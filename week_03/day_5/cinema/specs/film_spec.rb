...
class FilmTest < MiniTest::Test
  ...
  def setup
    ...
    @screening1 = Screening.new ({'start_time' => '01-FEB-2018 14:30', 'end_time' => '01-FEB-2018 16:00', 'film_id' => @film1.id, 'seats' => 10})
    @screening2 = Screening.new ({'start_time' => '01-FEB-2018 16:30', 'end_time' => '01-FEB-2018 18:00', 'film_id' => @film1.id, 'seats' => 10})
    @screening1.save()
    @screening2.save()
